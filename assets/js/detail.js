...
// devuelve todos los avances como una matriz
...
&append_to_response=casts,videos,images,releases`, function (movie) {
	...
	<div class="backrop-image" style="background-image: 
	...
	for (const { key, name } of filterVideos(videos)) {
		...
		videoCard.innerHTML = `
		<iframe width="500" height="294" src="https://www.
		youtube.com/embed/${key}?&theme=dark&color=white&rel=0"
	...
	${movieId}/similar?api_key=${api_key}&page=1`,
	addSuggestedMovies);
